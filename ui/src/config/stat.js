export const stat_desc = {
    ...
    Wisdom: "Help avoid beast ambush and the chance of crafting high-quality items.",
    Intelligence: "Helps avoid injuries while working and reduces damage from wild beast attacks.",
    Charisma: "Boost reduces the amount of tax paid on a transaction.",
